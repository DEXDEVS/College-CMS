...
class EmpInfoSearch extends EmpInfo
{
    ...
    public function rules()
    {
        return [
            ...
            [['emp_reg_no', 'emp_name', 'emp_father_name', 'emp_cnic', 'emp_contact_no', 'emp_perm_address', 'emp_temp_address', 'emp_marital_status', 'emp_fb_ID', 'emp_gender', 'emp_photo', 'emp_salart_type', 'group_by', 'emp_email', 'emp_qualification', 'emp_institute_name', 'degree_scan_copy', 'created_at', 'updated_at', 'delete_status'], 'safe'],
            [['emp_salary'], 'number'],
        ];
    }
    ...
    public function search($params)
    {
        ...
        $query->andFilterWhere(['like', 'emp_reg_no', $this->emp_reg_no])
            ...
            ->andFilterWhere(['like', 'emp_fb_ID', $this->emp_fb_ID])
            ->andFilterWhere(['like', 'emp_gender', $this->emp_gender])
            ->andFilterWhere(['like', 'emp_photo', $this->emp_photo])
            ->andFilterWhere(['like', 'emp_salart_type', $this->emp_salart_type])
