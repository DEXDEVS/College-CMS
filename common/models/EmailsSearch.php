...
class EmailsSearch extends Emails
{
    ...
    {
        return [
            [['emial_id', 'created_by', 'updated_by'], 'integer'],
            [['receiver_name', 'receiver_email', 'email_subject', 'email_content', 'email_attachment', 'created_at', 'updated_at'], 'safe'],
        ];
    }
    ...
    public function search($params)
    {
        ...
        $query->andFilterWhere(['like', 'receiver_name', $this->receiver_name])
            ...
            ->andFilterWhere(['like', 'email_attachment', $this->email_attachment]);
