...
class StdInquirySearch extends StdInquiry
{
    ...
    public function rules()
    {
        return [
            ...
            [['std_inquiry_no', 'inquiry_session', 'std_name', 'std_father_name', 'std_contact_no', 'std_father_contact_no', 'std_inquiry_date', 'std_intrested_class', 'std_previous_class', 'previous_institute', 'std_roll_no', 'std_percentage', 'refrence_name', 'refrence_contact_no', 'refrence_designation', 'std_address', 'inquiry_status', 'created_at', 'updated_at','gender','comment'], 'safe'],
        ];
    }
