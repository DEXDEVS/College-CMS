...
class StdRegistration extends \yii\db\ActiveRecord
{
    ...
    {
        return [
            [['std_reg_no', 'std_name', 'std_father_name', 'std_contact_no', 'std_DOB', 'std_gender', 'std_permanent_address', 'std_b_form', 'std_district', 'std_religion', 'std_nationality', 'std_tehseel'], 'required'],
            [['std_photo','std_DOB', 'created_at', 'updated_at', 'std_temporary_address', 'created_by', 'updated_by', 'std_email', 'status', 'academic_status','std_password'], 'safe'],
