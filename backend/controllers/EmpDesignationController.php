...
use common\models\EmpDesignationSearch;
...
class EmpDesignationController extends Controller
{
        ...
        if($request->isAjax){
            ...
            */
            if ($model->load($request->post()) && $model->save()) {
                return $this->redirect(['view', 'id' => $model->emp_designation_id]);
            } else {
    ...
    /**
     * Delete an existing EmpDesignation model.
     * For ajax request will return json object
    ...
    public function actionDelete($id)
    {
     ...
     /**
     * Delete multiple existing EmpDesignation model.
     * For ajax request will return json object
     * and for non-ajax request if deletion is successful, the browser will be redirected to the 'index' page.
     * @param integer $id
     * @return mixed
